...
list[3][4] = "Basilisk： Ouka Ninpouchou";
list[3][5] = "Citrus";
list[3][6] = "Gakuen Babysitters";
list[3][7] = "Grancrest Senki";
list[3][8] = "Itou Junji： Collection";
list[3][9] = "Jian Wangchao";
list[3][10] = "Karakai Jouzu no Takagi-san";
list[3][11] = "Kokkoku";
list[3][12] = "Mitsuboshi Colors";
list[3][13] = "Nanatsu no Taizai： Imashime no Fukkatsu";
list[3][14] = "Pochitto Hatsumei： Pikachin-Kit";
...
list[3][21] = "Yowamushi Pedal： Glory Line";
list[3][22] = "Yuru Camp△ ";
list[3][23] = "Zoku Touken Ranbu： Hanamaru";
list[3][24] = "gdMen(gdgd men’s party)"; 
list[3][25] = "Chihayafuru Syuukasen";
list[3][26] = "Ryuuou no Oshigoto!";
list[3][27] = "Dagashi Kashi 2";
list[3][28] = "Dame x Prince Anime Caravan";
list[3][29] = "Darling in the FranXX";
list[3][30] = "Death March kara Hajimaru Isekai Kyousoukyoku";
list[3][31] = "Gin no Guardian II";
list[3][32] = "Hitori no Shita： The Outcast 2";
list[3][33] = "Kaijuu Girls： Ultra Kaijuu Gijinka Keikaku (2018)";
list[3][34] = "Koi wa Ameagari no You ni"; 
list[3][35] = "Märchen Mädchen";
list[3][36] = "Miira no Kaikata";
list[3][37] = "Overlord II";
list[3][38] = "Overlord II Special";
list[3][39] = "Saiki Kusuo no Psi Nan 2";
list[3][40] = "Takunomi";
list[3][41] = "Violet Evergarden";
